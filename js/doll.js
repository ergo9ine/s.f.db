...
function Skill(y,x){
	...
	src==39?Sdesc=`표적에게 공격력의 ${x.Fx.dmg1[1]}배의 피해를 입힌 뒤 미사일을 발사하여 표적 주위 1.5범위 내의 적들에게 ${x.Fx.dmg2[1]}배의 피해를 입힌다`:
	...
	src==0||src==1||src==37||src==39||src==41||src==57||src==91||y==79||y==102||y==185?Sdesc+`<br>선쿨${x.FCD}초/쿨타임${x.CD[1]}초`:Sdesc+`<br>지속시간${time[1]}초/선쿨${x.FCD}초/쿨타임${x.CD[1]}초`;
