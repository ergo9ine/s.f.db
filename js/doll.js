...
function Skill(y,x){
	...
	src==0||src==1||src==13||src==22||src==37||src==39||src==41||src==57||src==91||src==94||src==96||y==79||y==102||y==185||y==1004||y==1005||y==1006||y==1009||y==1010?Sdesc+`<br>선쿨${x.FCD}초/쿨타임${x.CD[1]}초`:
